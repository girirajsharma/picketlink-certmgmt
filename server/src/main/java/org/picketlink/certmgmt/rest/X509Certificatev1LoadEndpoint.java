...
@Stateless
@Path("/X509Certificatev1Load")
public class X509Certificatev1LoadEndpoint {
    ...
    public X509Certificatev1Response create(X509Certificatev1LoadRequest request) throws Exception {
        ...
        if (myUser == null) {
            ...
            myUser = this.identityModelManager.loadAndStoreMyUser(request);
            this.identityManager.add(myUser);
            response.setStatus(200);
            response.setResponseStatus(ResponseStatus.LOADED_AND_STORED);
        } else {
