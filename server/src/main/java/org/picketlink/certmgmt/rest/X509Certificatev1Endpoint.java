...
public class X509Certificatev1Endpoint {
    ...
    public X509Certificatev1Response create(X509Certificatev1CreationRequest request) throws Exception {
        ...
        String days = request.getNumberOfDaysOfValidity();
        int version = 1;
        ...
        if (user == null) {
            ...
            user.setAttribute(new Attribute<String>("validity", days));
    ...
    public X509Certificatev1DetailResponse get(@PathParam("keyPassword") String keyPassword) {
        ...
        Object keyPairObj = user.getAttribute("keyPair");
        KeyPair keyPair = (KeyPair) keyPairObj;
        Object certificateObj = user.getAttribute("keyPair");
        Certificate certificate = (Certificate) certificateObj;
